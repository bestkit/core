...
use Bestkit\Http\Exception\RouteNotFoundException;
...
class Discussion
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $document->content = $this->view->make('bestkit.site::frontend.content.discussion', compact('apiDocument', 'page', 'hasPrevPage', 'hasNextPage', 'getResource', 'posts', 'url'));
