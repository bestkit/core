...
/**
 * Bestkit's central registry of known error types.
 *
 * It knows how to deal with errors raised both within Bestkit's core and outside
...
class Registry
{
     ...
     *
     * This can map internal ({@see \Bestkit\Foundation\KnownError}) as well as
     * external exceptions (any classes inheriting from \Throwable) to instances
     * of {@see \Bestkit\Foundation\ErrorHandling\HandledError}.
     *
