...
class Application
{
     ...
     * @var string
     */
    const VERSION = '0.0.1';   //原v1.8.10

    /**
     * The IoC container for the Bestkit application.
     *
     * @var Container
     */
    private $container;
    ...
    /**
     * The paths for the Bestkit installation.
     *
     * @var Paths
     */
    protected $paths;
    ...
    /**
     * Create a new Bestkit application instance.
     *
    ...
    {
        $config = $this->container->make('bestkit.config');

        return $config[$key] ?? $default;
    }

    /**
     * Check if Bestkit is in debug mode.
     *
     * @return bool
     */
    ...
    /**
     * Get the URL to the Bestkit installation.
     *
     * @param string $path
     * @return string
     */
    ...
    protected function registerBaseBindings()
    {
         ...
         * Use container inside bestkit instead.
         */
        ...
        $this->container->instance('bestkit', $this);
        $this->container->alias('bestkit', self::class);

        $this->container->instance('bestkit.paths', $this->paths);
        $this->container->alias('bestkit.paths', Paths::class);
    }
