...
use Bestkit\User\Event\Activated;
use Bestkit\User\Event\AvatarChanged;
use Bestkit\User\Event\Deleted;
...
use Bestkit\User\Event\Renamed;
...
class User extends AbstractModel
{
    ...
    public function getAvatarUrlAttribute(string $value = null)
    {
        if ($value && strpos($value, '://') === false) {
            return resolve(Factory::class)->disk('bestkit-avatars')->url($value);
        }
