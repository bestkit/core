...
namespace Bestkit\Frontend\Content;

use Bestkit\Foundation\Config;
use Bestkit\Frontend\Compiler\CompilerInterface;
...
class Assets
{
    ...
    {
        $this->assets = $this->container->make('bestkit.assets.'.$name);
