...
/**
 * A view which renders a HTML skeleton for Bestkit's frontend app.
 */
class Document implements Renderable
{
     ...
     * @var string
     */
    public $appView = 'bestkit::frontend.app';
     ...
     * @var string
     */
    public $contentView = 'bestkit::frontend.content';
    ...
    /**
     * Other variables to preload into the Bestkit JS.
     *
     * @var array
     */
    public $payload = [];
