...
class Event implements ExtenderInterface
{
    ...
    /**
     * Add a listener to a domain event dispatched by bestkit or a bestkit extension.
     *
    ...
    /**
     * Add a subscriber for a set of domain events dispatched by bestkit or a bestkit extension.
