...
class Policy implements ExtenderInterface
{
     ...
     *
     * @param string $policy: ::class attribute of policy class, which must extend Bestkit\User\Access\AbstractPolicy
     * @return self
     */
    ...
    {
        $container->extend('bestkit.policies', function ($existingPolicies) {
