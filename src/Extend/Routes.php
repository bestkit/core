...
class Routes implements ExtenderInterface
{
     ...
     * or extend one of the Bestkit Api controllers within \Bestkit\Api\Controller.
     *
     * The handler should accept:
     * - \Psr\Http\Message\ServerRequestInterface $request
     * - \Tobscure\JsonApi\Document $document: If it extends one of the Bestkit Api controllers.
     *
