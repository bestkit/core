...
class Model implements ExtenderInterface
{
     ...
     *                           This model should extend from \Bestkit\Database\AbstractModel.
     */
     ...
     * @param string $related: The ::class attribute of the model, which should extend \Bestkit\Database\AbstractModel.
     ...
     *                  like \Bestkit\User\User for examples of how relationships should be returned.
     *
     * @return self
     */
