...
class ModelUrl implements ExtenderInterface
{
     ...
     * @param string $driver: ::class attribute of driver class, which must implement Bestkit\Http\SlugDriverInterface.
     * @return self
     */
    ...
    {
        if ($this->slugDrivers) {
            $container->extend('bestkit.http.slugDrivers', function ($existingDrivers) {
