...
use Bestkit\Formatter\Formatter as ActualFormatter;
...
class Formatter implements ExtenderInterface, LifecycleInterface
{
     ...
     * - \Bestkit\User\User|null $actor. This argument MUST either be nullable, or omitted entirely.
     *
    ...
    {
        $container->extend('bestkit.formatter', function ($formatter, $container) {
