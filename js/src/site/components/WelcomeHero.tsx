...
export default class WelcomeHero extends Component<IWelcomeHeroAttrs> {
  ...
  contentItems(): ItemList<Mithril.Children> {
    ...
    items.add('title', <h1 className="Hero-title">{app.site.attribute('welcomeTitle')}</h1>, 100);

    items.add('subtitle', <div className="Hero-subtitle">{m.trust(app.site.attribute('welcomeMessage'))}</div>);
