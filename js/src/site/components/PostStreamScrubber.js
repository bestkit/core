...
export default class PostStreamScrubber extends Component {
  ...
  firstPostLabel() {
    return app.translator.trans('core.site.post_scrubber.original_post_link');
  }

  unreadLabel(unreadCount) {
    return app.translator.trans('core.site.post_scrubber.unread_text', { count: unreadCount });
  }

  lastPostLabel() {
    return app.translator.trans('core.site.post_scrubber.now_link');
  }
