...
export default class StatusWidget extends DashboardWidget {
  ...
  items() {
    ...
    items.add('version-bestkit', [<strong>Bestkit</strong>, <br />, app.site.attribute('version')], 100);
      ...
      items.add(
        ...
        [
          <span>
            ...
            <LinkButton href="https://discuss.bestkit.cn/d/24118" external={true} target="_blank" icon="fas fa-info-circle" />
          </span>,
          <br />,
