...
export default class ExtensionData {
   ...
   *
   * @example
   * app.extensionData.for('bestkit-tags')
   *
   * bestkit/flags -> bestkit-flags | acme/extension -> acme-extension
   */
  ...
  /**
   * This function registers your settings with Bestkit
   *
   ...
   *
   * .registerSetting({
   *   setting: 'bestkit-flags.guidelines_url',
   *   type: 'text', // This will be inputted into the input tag for the setting (text/number/etc)
   *   label: app.translator.trans('bestkit-flags.admin.settings.guidelines_url_label')
  ...
  /**
   * This function registers your permission with Bestkit
   *
   * @example
   *
   * .registerPermission('permissions', {
   *     icon: 'fas fa-flag',
   *     label: app.translator.trans('bestkit-flags.admin.permissions.view_flags_label'),
