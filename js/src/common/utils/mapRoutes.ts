import type { BestkitGenericRoute, RouteResolver } from '../Application';
 ...
 */
export default function mapRoutes(routes: Record<string, BestkitGenericRoute>, basePath: string = '') {
  const map: Record<
    string,
