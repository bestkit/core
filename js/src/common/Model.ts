...
import { BestkitRequestOptions } from './Application';
...
export default abstract class Model {
  ...
  save(
    ...
    options: Omit<BestkitRequestOptions<ApiPayloadSingle>, 'url'> & { meta?: MetaInformation } = {}
   ...
   */
  delete(body: BestkitRequestOptions<void>['body'] = {}, options: Omit<BestkitRequestOptions<void>, 'url'> = {}): Promise<void> {
