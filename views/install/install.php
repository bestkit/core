<h2>Install Bestkit</h2>

<p>Set up your site by filling out your details below. If you have any trouble, get help on the <a href="https://docs.bestkit.cn/install" target="_blank">Bestkit website</a>.</p>
...
<form method="post">
  ...
  <div class="FormButtons">
    <button type="submit">Install Bestkit</button>
  </div>
</form>
        ...
        .then(response => {
          if (response.ok) {
            ...
            response.text().then(errorMessage => {
              ...
              button.textContent = 'Install Bestkit';
            });
          }
        })
        .catch(error => {
